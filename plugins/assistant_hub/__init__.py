...
"助手（assistant / persona / pinned / today / longterm / dream）"
...
4. **运行时**
   ...
   把 personas/<yuan>/persona.md 拼成 prompt（人格 + 人工提示 + 记忆段）。这样子智能体上下文里"调用助手"
