...
用法（CLI）：
    ...
    python plugins/system-skills/skills/drifox-dev/scripts/state_manager.py show
    python plugins/system-skills/skills/drifox-dev/scripts/state_manager.py focus --task "重构 tool_control_card"
    python plugins/system-skills/skills/drifox-dev/scripts/state_manager.py pitfall --module tool_control_card --symptom "..." --cause "..." --fix "..."
    python plugins/system-skills/skills/drifox-dev/scripts/state_manager.py decision --scope "agent" --decision "..." --rationale "..."
