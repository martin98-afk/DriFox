...
![Version](https://img.shields.io/badge/version-0.5.12-brightgreen)
...
| 🔐 **系统密钥存储** | API Key 与 OAuth token 存于操作系统凭证库（Windows 凭据管理器 / macOS 钥匙串 / Linux Secret Service），配置文件与云端备份不含明文密钥 |
